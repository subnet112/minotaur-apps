...
Thanks for your interest in the Minotaur App Intent contracts + UI. This guide covers the basics — how to file an issue, how to run the tests locally, and what to expect from the review process.
...
3. Run the test suite locally before pushing:
   ...
   ```bash
   forge install                  # one-time: install OpenZeppelin et al.
   forge build                    # compile contracts
   forge test -v                  # contract tests
   ```
